    ...
    <div className="mx-auto max-w-lg px-4 py-16 sm:px-6">
      ...
      <div className="bg-white border border-slate-100 rounded-3xl p-6 sm:p-10 shadow-lg">
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={() => {
              window.location.href = `https://tpdmumgyxatarkmwjjpu.supabase.co/auth/v1/authorize?provider=google&redirect_to=${encodeURIComponent(window.location.origin)}`;
            }}
            className="w-full cursor-pointer flex items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 font-semibold text-slate-700 py-3 text-sm transition shadow-xs"
          >
